...
public class JdbcScoreRepository implements ScoreRepository{
    ...
    // @RequiredArgsConstructor 어노테이션이 자동으로 아래 생성자 주입 자동으로 만들어 줌.
...
//    }
    ...
    public void save(Score score) {
        ...
        template.update(sql, score.getName(), score.getKor(), score.getEng(), score.getMath(), score.getTotal(), score.getAverage());
    }
    ...
    // 내부 클래스 (inner class)
    // JdbcScoreRepository 에서만 사용할 전용 클래스
