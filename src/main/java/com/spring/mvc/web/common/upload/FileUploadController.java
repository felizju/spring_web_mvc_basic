...
public class FileUploadController {
    ...
    // 업로드파일 저장 경로
    private static final String UPLOAD_PATH = "D:\\developing_yeonju\\upload";

    // upload-form.jsp 열어주는 처리
    ...
    public String upload(@RequestParam("file") List<MultipartFile> fileList) throws IOException {
        ...
        for (MultipartFile file : fileList) {
            ...
            // 업로드파일의 정보 객체를 생성
            // file클래스의 생성자를 통해 첫번째 파라미터로 저장경로를 두번째 파라미터로 파일명을 넣어줌
